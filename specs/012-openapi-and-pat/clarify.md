...
- PAT management UI location: under the user's profile/account settings page, reachable from avatar navigation; admin token management is reachable from avatar admin navigation.
