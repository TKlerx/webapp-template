# Agent setup for `webapp-template`

This is a deepsec scanning workspace. Project `webapp-template` was just registered
(target: `..`). Setup is incomplete — `data/webapp-template/INFO.md`
...
2. **Fill in `data/webapp-template/INFO.md`.** It's auto-injected into the AI
...
pnpm deepsec process --project-id webapp-template
```
